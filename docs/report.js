    ...
    try {
        ...
        // ------------------------------------------
            ...
            if (invitationDateError) {
                ...
                message.textContent =
                    "Could not determine ballot dates.";
        ...
        if (
            ...
            // Recirculation begins when
            // the original ballot ended.
